...
var SHOPIFY_API_LIBRARY_VERSION = "11.4.0";
...
var DEFAULT_SDK_VARIANT = "storefront-api-client";
var DEFAULT_CLIENT_VERSION = "1.0.2";
...
var CLIENT = "Storefront API Client";
...
function subscriptions(config) {
  return async function({ session }) {
    ...
    return (_b2 = response.data) == null ? void 0 : _b2.currentAppInstallation;
  };
}
...
function createUsageRecord(config) {
  return async function createUsageRecord2(usageRecordInfo) {
    ...
    try {
      ...
      return (_f = (_e = response.data) == null ? void 0 : _e.appUsageRecordCreate) == null ? void 0 : _f.appUsageRecord;
    } catch (error) {
      if (error instanceof GraphqlQueryError) {
        throw new BillingError({
          message: error.message,
...
//# sourceMappingURL=chunk-JFBXKOQ3.js.map
